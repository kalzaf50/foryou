...
document.getElementById('showFlowersBtn').addEventListener('click', function() {
        ...
        }, 1140); // 1000ms for the first image drop + 500ms delay
        ...
        }, 1180); // 1500ms for the second image transition + 500ms delay

        setTimeout(function() {
                waterDrop4.style.opacity = 0; // Hide the third image
            }, 1220); // 1500ms for the second image transition + 500ms delay
    });